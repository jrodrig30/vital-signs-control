...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_ow_menus_ow_menus1_idx' => ['type' => 'index', 'columns' => ['menu_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_ow_menus_ow_menus1' => ['type' => 'foreign', 'columns' => ['menu_id'], 'references' => ['menus', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
